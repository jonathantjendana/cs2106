...
#define ensure_successful_calloc(ptr)                           \
    if (ptr == NULL) {                                          \
...
int main(int argc, char** argv)
{
    ...
    cars = calloc (num_of_cars, sizeof (car_struct));
    ensure_successful_calloc(cars);
    
    segments = calloc (num_of_segments, sizeof (segment_struct));
    ensure_successful_calloc (segments);
